...
class Day2 : Day() {
    ...
    private val presents = ArrayList<Present>()

    init {
        INPUT.forEach {
            val sides = it.split("x")
            presents.add(Present(sides[0].toInt(), sides[1].toInt(), sides[2].toInt()))
        }
    }
    ...
    override fun partOne(): String {
        ...
        presents.forEach {
            squareFeet += it.surfaceArea() + it.slack()
        }

        return squareFeet.toString()
    }
    ...
    data class Present(val l: Int, val w: Int, val h: Int) {
        ...
        fun slack(): Int = arrayOf(l * w, l * h, w * h).min()!!
        fun ribbon(): Int {
